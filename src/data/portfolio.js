...
const portfolio = [
  ...
  },
  {
    ...
    more: {
      ...
      url:
        'http://blog.beacontechnologies.com/beacon-unveils-its-new-responsive-website/'
    },
    cms: ['Cascade Server'],
  ...
  },
  {
    ...
    notes:
      'Please Note:  Site may not function correctly from a desktop since it is made for mobile devices.',
    cms: ['Cascade Server'],
    other: ['Cross Browser Compatibility'],
    images: [
      'bassett-furniture-1.png',
      'bassett-furniture-2.png',
      'bassett-furniture-3.png',
      'bassett-furniture-4.png'
    ]
  },
  {
